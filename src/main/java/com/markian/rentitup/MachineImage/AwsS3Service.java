...
public class AwsS3Service {
    ...
    public String saveImageToS3(MultipartFile photo) {
        ...
        try {
            ...
            throw new MachineImageException("Unable to uploadimage to s3 bucket" + e.getMessage(), e);
        }
    }
    ...
    public void deleteImageFromS3(String imageUrl) {
        try {
            ...
            throw new MachineImageException("Unable to delete image from s3 bucket: " + e.getMessage(), e);
        }
    }
}
